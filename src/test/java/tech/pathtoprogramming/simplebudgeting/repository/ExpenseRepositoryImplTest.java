...
class ExpenseRepositoryImplTest {
    ...
    private final LocalDate todaysDate = LocalDate.of(2021, 5, 24);
    ...
    void addExpense_savesNewExpenseToTheDatabase() {
        expenseRepository.addExpense(createExpense(NEW_USERNAME, LocalDate.of(2021, 5, 23), 1200.00, "SHOPPING", "Workout Equipment"));
    ...
    void updateExpense_retrievesCurrentExpense_andUpdatesItInTheDatabase() {
        Expense updatedExpense4 = expense4.toBuilder().transactionDate(LocalDate.of(2021, 4, 11)).build();

        Expense updatedExpense = expenseRepository.updateExpense(updatedExpense4);

        assertThat(updatedExpense.getTransactionDate()).isEqualTo(LocalDate.of(2021, 4, 11));
    }
    ...
    private void initializeData() {
        ...
        expense3 = mongoTemplate.insert(createExpense(USERNAME, LocalDate.of(2021, 5, 23), 112.99, "ENTERTAINMENT", "Bowling"), EXPENSES_COLLECTION);
        expense4 = mongoTemplate.insert(createExpense(NEW_USERNAME, LocalDate.of(2021, 5, 1), 120.00, "GROCERIES", ""), EXPENSES_COLLECTION);
        expense5 = mongoTemplate.insert(createExpense(USERNAME, LocalDate.of(2021, 4, 15), 76.99, "UTILITIES", "Electric Bill"), EXPENSES_COLLECTION);
    }
}